...
interface EligibilityComparisonProps {
  ...
  negativeItems?: ListItem[];
  positiveItems?: ListItem[];
  accentColor?: string;
}
const defaultNegativeItems: ListItem[] = [{
  id: 1,
  text: 'Denkt dat het allemaal wel losloopt'
}, {
  id: 2,
  text: 'Wacht tot je een opdracht verliest voor je actie onderneemt'
}, {
  id: 4,
  text: 'Geen serieuze onderneming wil opbouwen'
}, {
  id: 5,
  text: 'Alles liever zelf uitzoekt'
}];
const defaultPositiveItems: ListItem[] = [{
  id: 1,
  text: "Zelfstandig werkt als zzp'er in Nederland"
}, {
  id: 2,
  text: 'Begrijpt dat de markt veranderd is'
}, {
  id: 3,
  text: 'Nu voorop wil lopen in plaats van straks bij te benen'
}, {
  id: 4,
  text: 'Minder discussie wil over jouw zelfstandigheid bij inhuur'
}, {
  id: 5,
  text: 'Meer opdrachten wil binnenhalen met een sterk profiel'
}];

// @component: EligibilityComparison
export const EligibilityComparison = ({
  subtitle = 'Checklist',
  negativeTitle = 'Dit is niet voor jou als je...',
  positiveTitle = 'Dit is voor jou als je...',
  negativeItems = defaultNegativeItems,
  positiveItems = defaultPositiveItems,
  accentColor = '#E07B39'
}: EligibilityComparisonProps) => {
  return <section className="w-full bg-[#F7F5F2] py-16 sm:py-24 lg:py-32 px-5 sm:px-8">
      <div className="max-w-[1380px] mx-auto">
        ...
        <div className="mb-14 sm:mb-20 lg:mb-24 text-center flex flex-col items-center">
          ...
          duration: 0.6
            ...
            <div className="w-10 h-[1px]" style={{
            backgroundColor: accentColor
          }} />
            <span className="font-bold tracking-[0.2em] uppercase text-xs" style={{
            color: accentColor
          ...
          duration: 0.6,
          delay: 0.1
        }} className="text-[34px] sm:text-[48px] lg:text-[56px] xl:text-[72px] font-serif text-[#1E2238] tracking-tight leading-[1.1] max-w-4xl">
            <span>Is dit iets voor </span>
        ...
        duration: 0.8,
        delay: 0.2
      }} className="grid md:grid-cols-2 bg-white border border-[#1E2238]/12 rounded-[32px] sm:rounded-[40px] overflow-hidden shadow-[0_32px_64px_-16px_rgba(0,0,0,0.04)]">
          {/* Negative Section */}
          <div className="p-8 sm:p-12 md:p-16 lg:p-20 border-b md:border-b-0 md:border-r border-[#1E2238]/10 bg-[#F7F5F2]/60">
            <h3 className="text-xl sm:text-2xl md:text-3xl font-serif text-[#1E2238] mb-8 sm:mb-12 flex items-center gap-3 sm:gap-4">
              <span className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-red-50 flex items-center justify-center shrink-0">
                <X size={14} className="text-red-500" />
              </span>
              <span>{negativeTitle}</span>
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              delay: 0.1 * index
                  ...
                  <p className="text-[#1E2238]/60 text-base sm:text-lg font-light leading-relaxed group-hover:text-[#1E2238] transition-colors">
                    {item.text}
                  </p>
                </motion.div>)}
            </div>
          ...
          <div className="p-8 sm:p-12 md:p-16 lg:p-20 bg-white">
            <h3 className="text-xl sm:text-2xl md:text-3xl font-serif text-[#1E2238] mb-8 sm:mb-12 flex items-center gap-3 sm:gap-4">
              <span className="w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center shrink-0" style={{
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              delay: 0.1 * index
                  ...
                  <div className="mt-1 w-5 h-5 rounded-full flex items-center justify-center shrink-0 transition-all duration-300 border group-hover:border-transparent" style={{
                borderColor: `${accentColor}40`
              }}>
                    <Check size={10} className="transition-colors" style={{
                  color: accentColor
                }} strokeWidth={3} />
                  </div>
                  <p className="text-[#1E2238]/60 text-base sm:text-lg font-light leading-relaxed group-hover:text-[#1E2238] transition-colors">
        ...
        delay: 0.5
          ...
          <div className="flex items-center gap-3 sm:gap-4 px-4 sm:px-6 py-3 bg-white border border-[#1E2238]/12 rounded-full">
            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center shrink-0 border" style={{
            backgroundColor: `${accentColor}15`,
            borderColor: `${accentColor}25`
          }}>
              <UserRound className="w-4 h-4" style={{
              color: accentColor
            }} />
            </div>
            <span className="text-[10px] sm:text-[11px] font-bold text-[#1E2238]/40 uppercase tracking-widest text-center">
              2500+ andere zzp'ers zijn zich hiervan bewust
            </span>
          </div>
        </motion.div>
